...
describe GContacts::Element do
  ...
  context "converts back to xml" do
    ...
    it "with creating an entry" do
      ...
      Nori.parse(element.to_xml).should == {"atom:entry" => {"@xmlns:atom"=>"http://www.w3.org/2005/Atom", "@xmlns:gd"=>"http://schemas.google.com/g/2005", "category" => {"@scheme" => "http://schemas.google.com/g/2005#kind", "@term" => "http://schemas.google.com/g/2008#contact"}, "updated" => DateTime.parse("2012-04-06T06:02:04Z"), "content" => "Foo Content", "title" => "Foo Title", "gd:name" => {"gd:fullName" => "John Doe", "gd:givenName" => "John", "gd:familyName" => "Doe"}}}
    ...
    it "updating an entry in batch" do
      ...
      Nori.parse(element.to_xml).should == {"atom:entry" => {"id" => "http://www.google.com/m8/feeds/contacts/john.doe%40gmail.com/base/3a203c8da7ac0a8", "category" => {"@scheme" => "http://schemas.google.com/g/2005#kind", "@term" => "http://schemas.google.com/g/2008#contact"}, "updated" => DateTime.parse("2012-04-06T06:02:04Z"), "content" => {"@type" => "text"}, "title" => "Casey", "gd:name" => {"gd:fullName" => "Casey", "gd:givenName" => "Casey"}, "gd:email" => {"@rel" => "http://schemas.google.com/g/2005#other", "@address" => "casey@gmail.com", "@primary" => "true"}, "@gd:etag" => '"YzllYTBkNmQwOWRlZGY1YWEyYWI5."', "@xmlns:atom"=>"http://www.w3.org/2005/Atom", "@xmlns:gd"=>"http://schemas.google.com/g/2005"}}
    ...
    it "with groups" do
      ...
      expected = [
          {"atom:entry" => {"id" => "http://www.google.com/m8/feeds/groups/john.doe%40gmail.com/base/6", "category" => {"@scheme" => "http://schemas.google.com/g/2005#kind", "@term" => "http://schemas.google.com/g/2008#group"}, "updated" => DateTime.parse("2012-04-06T06:02:04Z"), "content" => {"@type" => "text"}, "title" => "System Group: My Contacts", "@gd:etag" => '"YWJmYzA."', "@xmlns:atom"=>"http://www.w3.org/2005/Atom", "@xmlns:gd"=>"http://schemas.google.com/g/2005"}},
          {"atom:entry" => {"id" => "http://www.google.com/m8/feeds/groups/john.doe%40gmail.com/base/ada43d293fdb9b1", "category" => {"@scheme" => "http://schemas.google.com/g/2005#kind", "@term" => "http://schemas.google.com/g/2008#group"}, "updated" => DateTime.parse("2012-04-06T06:02:04Z"), "content" => {"@type" => "text"}, "title" => "Misc", "@gd:etag" => '"QXc8cDVSLyt7I2A9WxNTFUkLRQQ."', "@xmlns:atom"=>"http://www.w3.org/2005/Atom", "@xmlns:gd"=>"http://schemas.google.com/g/2005"}}
      ]
